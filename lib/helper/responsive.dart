...
class SizeConfig extends StatelessWidget {
  ...
  static late double bottomPadding = MediaQueryData.fromWindow(WidgetsBinding.instance!.window).padding.bottom;
  static late double topPadding = MediaQueryData.fromWindow(WidgetsBinding.instance!.window).padding.top;
